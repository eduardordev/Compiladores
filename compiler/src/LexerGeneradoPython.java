...
public class LexerGeneradoPython {
    ...
    public static void getTokens(String input) {
        ...
        while (i < input.length()) {
            ...
            while (j < input.length()) {
                ...
                switch (estado) {
                    case 0:
                        switch (c) {
                            ...
                            case '\"': estado = 5; j++; break;
                            case 'b': estado = 6; j++; break;
                            case 'c': estado = 7; j++; break;
                            case 'd': estado = 8; j++; break;
                            case 'e': estado = 9; j++; break;
                            case '%': estado = 10; j++; break;
                            case '&': estado = 11; j++; break;
                            case 'f': estado = 12; j++; break;
                            case '(': estado = 13; j++; break;
                            case 'i': estado = 14; j++; break;
                            case ')': estado = 15; j++; break;
                ...
                if (estado == 1 || estado == 2 || estado == 3 || estado == 4 || estado == 5 || estado == 69 || estado == 71 || estado == 10 || estado == 74 || estado == 76 || estado == 13 || estado == 77 || estado == 15 || estado == 16 || estado == 17 || estado == 81 || estado == 18 || estado == 82 || estado == 20 || estado == 84 || estado == 21 || estado == 22 || estado == 86 || estado == 23 || estado == 87 || estado == 24 || estado == 88 || estado == 27 || estado == 28 || estado == 29 || estado == 31 || estado == 32 || estado == 33 || estado == 34 || estado == 39 || estado == 43 || estado == 51 || estado == 52 || estado == 53 || estado == 54 || estado == 61 || estado == 62) {
            ...
            if (ultimoAceptado != -1) {
                ...
                switch (ultimoAceptado) {
                    ...
                    case 51: System.out.println("LE");; break;
                    case 31: System.out.println("RBRACE");; break;
                    case 53: System.out.println("EQ");; break;
                    case 52: System.out.println("OR");; break;
                    case 74: System.out.println("MAIN");; break;
                    case 33: System.out.println("GT");; break;
                    case 77: System.out.println("VOID_TYPE");; break;
                    case 10: System.out.println("MODULO");; break;
                    case 32: System.out.println("ASSIGN");; break;
                    ...
                    case 15: System.out.println("RPAREN");; break;
                    ...
                    case 5: System.out.println("LBRACKET");; break;
                    ...
                    case 29: System.out.println("LT");; break;
                }
                i = finLexema;
            } else {
